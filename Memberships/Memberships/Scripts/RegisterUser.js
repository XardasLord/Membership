$(function () {
    ...
    function onRegisterUserClick() {
        ...
        $.post(url, {
            __RequestVerificationToken: antiforgery, email: email, name: name, password: password, acceptUserAgreement: true
        },
            function (data) {
                ...
                if (hasErrors === true) {
                    ...
                    registerUserCheckBox = $('#AcceptUserAgreement').click(onToogleRegisterUserDisableClick);
